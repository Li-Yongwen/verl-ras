...
project_name='GRPO-Qwen2.5-megatron'
exp_name="${model_name}-npu-megatron"
gen_tp=2

MODEL_PATH="models/${model_name}"
CKPTS_DIR="models/${model_name}-save/"
TRAIN_FILE='datasets/gsm8k/train.parquet'
TEST_FILE='datasets/gsm8k/test.parquet'

# ROLLOUT_DATA_DIR='models/${model_name}-rollout-save/'
